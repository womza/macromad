	...
	var ContentComposer = function (element, parameters) { 
		...
		obj.methods = { 
			...
			setVars : function () { 
				...
				obj.methods.composerURL = $('#cmsmasters_composer_url').val();
			...
			appendRowControl : function (el) { 
				...
				el.wrapInner('<div class="innerRow" />').prepend('<div class="innerHead">' + 
					...
					'<a href="#" class="cmsmastersDelBut admin-icon-remove" title="' + cmsmasters_composer.remove_section + '" />' + 
					'<a href="#" class="cmsmastersCopyBut admin-icon-copy" title="' + cmsmasters_composer.clone_section + '" />' + 
					'<a href="#" class="cmsmastersEditBut admin-icon-edit" title="' + cmsmasters_composer.edit_section + '" />' + 
			...
			appendColumnControl : function (el) { 
				el.wrapInner('<div class="innerColumn" />').prepend('<div class="innerHead">' + 
					...
					'<a href="#" class="cmsmastersAddBut admin-icon-add" title="' + cmsmasters_composer.add_shortcode + '" />' + 
					'<a href="#" class="cmsmastersEditBut admin-icon-edit" title="' + cmsmasters_composer.edit_column + '" />' + 
				'</div>').find('.innerColumn').append('<a href="#" class="cmsmastersAddBut admin-icon-add" title="' + cmsmasters_composer.add_shortcode + '" />');
			}, 
			appendShCdControl : function (el) { 
				el.wrapInner('<div class="innerShortcode" />').prepend('<div class="innerHead">' + 
					'<a href="#" class="cmsmastersDelBut admin-icon-remove" title="' + cmsmasters_composer.remove_shortcode + '" />' + 
					'<a href="#" class="cmsmastersCopyBut admin-icon-copy" title="' + cmsmasters_composer.clone_shortcode + '" />' + 
					'<a href="#" class="cmsmastersEditBut admin-icon-edit" title="' + cmsmasters_composer.edit_shortcode + '" />' + 
				'</div>').append('<a href="#" class="cmsmastersEditShortcodeBut admin-icon-edit" />');
			}, 
			startObj : function () { 
				obj.methods.resetBlocks();
				...
				obj.methods.el.sortable( { 
					...
					start : function (event, ui) { 
						var placeClasses = ui.item.context.className.replace(/cmsmasters_\S+/g, '').replace(/ui-\S+/g, '');
						...
						obj.methods.button_row.draggable( { 
							...
							start : function (event, ui) {
								$(ui.helper).attr('class', 'cmsmasters_row').css( { 
									...
									height: 75, 
									padding : '25px 0 0' 
								} ).addClass('ui-front').wrapInner('<div class="cmsmasters_row" />').empty().append('<div class="innerRow" />').find('.innerRow').height(63).append('<span class="cmsmastersShortcodeTitle admin-icon-row" />').parent().prepend('<div class="innerHead">' + 
									'<span>' + cmsmastersRow.title + '</span>' + 
								'</div>');
							} 
						} );
