...
(function ($) { 
	$(document).ready(function () { 
		...
		if ($('#post-formats-select input.post-format:checked').val() === 'image') {
			...
			$('#cmsmasters_project_images .cmsmasters_tr_rgba').show();
		...
		$('#post-formats-select input.post-format').on('change', function () { 
			if ($(this).val() === 'image') {
				$('#cmsmasters_post_gallery, #cmsmasters_post_video, #cmsmasters_post_audio, #cmsmasters_project_images, #cmsmasters_project_video').hide();
				
				$('#cmsmasters_post_image').show();
			} else if ($(this).val() === 'gallery') {
				$('#cmsmasters_post_image, #cmsmasters_post_video, #cmsmasters_post_audio, #cmsmasters_project_video').hide();
				...
				$('#cmsmasters_post_image, #cmsmasters_post_gallery, #cmsmasters_post_audio, #cmsmasters_project_images').hide();
				...
				$('#cmsmasters_post_image, #cmsmasters_post_gallery, #cmsmasters_post_video, #cmsmasters_project_images, #cmsmasters_project_video').hide();
				...
				$('#cmsmasters_project_images .cmsmasters_tr_rgba').hide();
			}
		} );
		...
		if ($('input[name="cmsmasters_heading"]:checked').val() === 'custom') {
			...
			$('#cmsmasters_heading_bg_img_enable').closest('tr').show();
			
			
			if ($('#cmsmasters_heading_bg_img_enable:checked')) {
		...
		$('input[name="cmsmasters_heading"]').on('change', function () { 
			if ($(this).val() === 'default') {
				...
				$('#cmsmasters_breadcrumbs').closest('tr').show();
				$('#cmsmasters_heading_bg_img_enable').closest('tr').show();
				$('#cmsmasters_heading_bg_color').closest('tr').show();
				...
				$('#cmsmasters_heading_bg_img_enable').closest('tr').hide();
				$('#cmsmasters_heading_bg_color').closest('tr').hide();
			}
		} );
