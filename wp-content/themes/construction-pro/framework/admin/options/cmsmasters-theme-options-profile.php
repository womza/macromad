...
$cmsmasters_global_profile_post_details_title = (isset($cmsmasters_option[CMSMASTERS_SHORTNAME . '_profile_post_details_title']) && $cmsmasters_option[CMSMASTERS_SHORTNAME . '_profile_post_details_title'] !== '') ? $cmsmasters_option[CMSMASTERS_SHORTNAME . '_profile_post_details_title'] : esc_html__('Profile details', 'construction-pro');
...
$tabs_array['cmsmasters_profile'] = array( 
	'label' => esc_html__('Profile', 'construction-pro'), 
...
$custom_profile_meta_fields = array( 
	...
	array( 
		'label'	=> esc_html__('Profile Title', 'construction-pro'), 
	...
	array( 
		'label'	=> esc_html__('Subtitle', 'construction-pro'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> esc_html__('Profile Details Title', 'construction-pro'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> esc_html__('Social Icons', 'construction-pro'), 
		'desc'	=> esc_html__('Add social icons for this profile', 'construction-pro'), 
	...
	array( 
		'label'	=> esc_html__('Profile Info', 'construction-pro'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> esc_html__('Profile Features 1 Title', 'construction-pro'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> esc_html__('Profile Features 1', 'construction-pro'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> esc_html__('Profile Features 2 Title', 'construction-pro'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> esc_html__('Profile Features 2', 'construction-pro'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> esc_html__('Profile Features 3 Title', 'construction-pro'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> esc_html__('Profile Features 3', 'construction-pro'), 
		'desc'	=> '', 
