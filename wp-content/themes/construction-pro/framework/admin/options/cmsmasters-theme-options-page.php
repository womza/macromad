...
$cmsmasters_global_header_overlaps = (isset($cmsmasters_option[CMSMASTERS_SHORTNAME . '_header_overlaps']) && $cmsmasters_option[CMSMASTERS_SHORTNAME . '_header_overlaps'] !== '') ? (($cmsmasters_option[CMSMASTERS_SHORTNAME . '_header_overlaps'] == 1) ? 'true' : 'false') : 'false';
...
$custom_page_meta_fields = array( 
	...
	array( 
		'label'	=> esc_html__('Header Overlaps Content', 'construction-pro'), 
	...
	array( 
		'label'	=> esc_html__('Disabled Heading Block', 'construction-pro'), 
		'desc'	=> esc_html__('Use this checkbox to disable heading block', 'construction-pro'), 
