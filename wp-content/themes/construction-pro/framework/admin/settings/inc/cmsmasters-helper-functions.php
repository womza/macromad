...
function construction_pro_get_admin_page() {
	global $pagenow;
...
function construction_pro_default_tab() {
	$current_page = construction_pro_get_admin_page();
...
function construction_pro_get_the_tab() {
	global $pagenow;
	
	$default_tab = construction_pro_default_tab();
...
function construction_pro_settings_page_header() {
