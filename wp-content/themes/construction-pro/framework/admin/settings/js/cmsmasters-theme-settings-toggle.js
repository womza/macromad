...
(function ($) { 
	...
	if ($('#' + cmsmasters_settings.shortname + '_header_top_line').is(':not(:checked)')) {
		...
		$('#' + cmsmasters_settings.shortname + '_header_top_bg_img_enable').parents('tr').hide();
	...
	if ($('input[name*="' + cmsmasters_settings.shortname + '_header_styles"]:checked').val() === 'default') {
		...
		$('#' + cmsmasters_settings.shortname + '_header_bot_add_cont').parents('tr').hide();
		$('#' + cmsmasters_settings.shortname + '_header_bot_add_cont_cust_html').parents('tr').hide();
	}
	...
	if ($('#' + cmsmasters_settings.shortname + '_header_bot_add_cont').is(':not(:checked)')) {
		$('#' + cmsmasters_settings.shortname + '_header_bot_add_cont_cust_html').parents('tr').hide();
	}
	...
	$('#' + cmsmasters_settings.shortname + '_header_top_line').on('change', function () { 
		if ($('#' + cmsmasters_settings.shortname + '_header_top_line').is(':checked')) {
			...
			$('#' + cmsmasters_settings.shortname + '_header_top_line_bg_img_enable').parents('tr').show();
			if ($('#' + cmsmasters_settings.shortname + '_header_top_line_bg_img_enable').is(':checked')) {
				$('#' + cmsmasters_settings.shortname + '_header_top_line_bg_img').parents('tr').show();
			}
			...
			$('#' + cmsmasters_settings.shortname + '_header_top_scheme').parents('tr').hide();
			$('#' + cmsmasters_settings.shortname + '_header_top_height').parents('tr').hide();
			$('#' + cmsmasters_settings.shortname + '_header_top_line_bg_img_enable').parents('tr').hide();
			$('#' + cmsmasters_settings.shortname + '_header_top_line_bg_img').parents('tr').hide();
			$('#' + cmsmasters_settings.shortname + '_header_top_line_short_info').parents('tr').hide();
			$('input[name*="' + cmsmasters_settings.shortname + '_header_top_line_add_cont"]').parents('tr').hide();
		}
	} );
	
	/* Header 'Top Line Background' Tab Fields Load */
	$('#' + cmsmasters_settings.shortname + '_header_top_line_bg_img_enable').parents('tr').show();
	if ($('#' + cmsmasters_settings.shortname + '_header_top_line_bg_img_enable').is(':not(:checked)')) {
		$('#' + cmsmasters_settings.shortname + '_header_top_line_bg_img').parents('tr').hide();
		
	}
	
	/* Header 'Top Line Background' Tab Fields Change */
	$('#' + cmsmasters_settings.shortname + '_header_top_line_bg_img_enable').on('change', function () { 
		if ($('#' + cmsmasters_settings.shortname + '_header_top_line_bg_img_enable').is(':checked')) {
			$('#' + cmsmasters_settings.shortname + '_header_top_line_bg_img').parents('tr').show();
		} else {
			$('#' + cmsmasters_settings.shortname + '_header_top_line_bg_img').parents('tr').hide();
	...
	$('input[name*="' + cmsmasters_settings.shortname + '_header_styles"]').on('change', function () { 
		if ($('input[name*="' + cmsmasters_settings.shortname + '_header_styles"]:checked').val() === 'default') {
			...
			$('#' + cmsmasters_settings.shortname + '_header_bot_add_cont').parents('tr').show();
			
			if ($('input[name*="' + cmsmasters_settings.shortname + '_header_add_cont"]:checked').val() === 'cust_html') {
				$('#' + cmsmasters_settings.shortname + '_header_add_cont_cust_html').parents('tr').show();
			}
			
			if ($('#' + cmsmasters_settings.shortname + '_header_bot_add_cont').is(':checked')) {
				$('#' + cmsmasters_settings.shortname + '_header_bot_add_cont_cust_html').parents('tr').show();
			} else {
				$('#' + cmsmasters_settings.shortname + '_header_bot_add_cont_cust_html').parents('tr').hide();
			}
		}
	...
	$('#' + cmsmasters_settings.shortname + '_header_bot_add_cont').on('change', function () { 
		if ($('#' + cmsmasters_settings.shortname + '_header_bot_add_cont').is(':checked')) {
			$('#' + cmsmasters_settings.shortname + '_header_bot_add_cont_cust_html').parents('tr').show();
		} else {
			$('#' + cmsmasters_settings.shortname + '_header_bot_add_cont_cust_html').parents('tr').hide();
	...
	if ($('input[name*="' + cmsmasters_settings.shortname + '_footer_type"]:checked').val() !== 'small') {
		...
		$('#' + cmsmasters_settings.shortname + '_fixed_footer').parents('tr').hide();
		$('#' + cmsmasters_settings.shortname + '_footer_height').parents('tr').hide();
	...
	$('input[name*="' + cmsmasters_settings.shortname + '_footer_type"]').on('change', function () { 
		if ($('input[name*="' + cmsmasters_settings.shortname + '_footer_type"]:checked').val() === 'small') {
			...
			$('#' + cmsmasters_settings.shortname + '_fixed_footer').parents('tr').show();
			$('#' + cmsmasters_settings.shortname + '_footer_height').parents('tr').show();
