...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php 
		construction_pro_thumb_rollover(get_the_ID(), 'cmsmasters-project-thumb', true, true, true, false, $cmsmasters_project_video_type, $cmsmasters_project_video_link, $cmsmasters_project_video_links, false, true, $cmsmasters_project_link_redirect, $cmsmasters_project_link_url);
