	...
	<?php 
		...
		if (!$title) {
			echo '<div class="dn">';
				...
				construction_pro_project_heading(get_the_ID(), 'h4', true, $cmsmasters_project_link_redirect, $cmsmasters_project_link_url);
		...
		if ($title || $categories || $excerpt || $likes || $comments) {
			echo '<div class="project_inner">';
				...
				($title) ? construction_pro_project_heading(get_the_ID(), 'h4') : '';
