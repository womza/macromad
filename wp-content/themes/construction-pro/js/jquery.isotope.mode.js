...
function setPuzzleColumnWidth(container) { 
	var containerWidth = container.width(), 
		...
		postStaticHeight = Math.floor((postStaticWidth / 100) * 60.3/* preloader padding bottom in % */), 
		postStaticPadding = Math.floor(((postPaddingLeft + postPaddingRight) / 100) * 60.3/* preloader padding bottom in % */), 
