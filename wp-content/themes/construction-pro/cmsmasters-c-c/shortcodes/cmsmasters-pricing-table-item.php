 ...
 * @version 	1.0.0
 * 
 * Content Composer Single Pricing Table Items Shortcode
...
$price_out = '<div class="cmsmasters_pricing_item_wrap">' . 
	'<div id="cmsmasters_pricing_item_' . $unique_id . '" class="cmsmasters_pricing_item' . 
	...
	'>' . "\n" . 
		'<div class="cmsmasters_pricing_item_inner">' . "\n" . 
			'<div class="pricing_header">' . "\n" . 
				...
				(($period != '') ? '<span class="cmsmasters_period">' . $period . '</span>' . "\n" : '') . 
				'</div>' . "\n" . 
			'</div>' . "\n"; 
